...
MCFixupKindInfo RISCVAsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  const static MCFixupKindInfo Infos[] = {
      ...
      {"fixup_riscv_base_idx_lo12_i", 20, 12, 0},
      {"fixup_riscv_base_idx_lo12_s", 0, 32, 0},
      {"fixup_riscv_base_idx_add", 0, 0, 0},
      {"fixup_riscv_pcrel_hi20", 12, 20, 0},
      {"fixup_riscv_pcrel_lo12_i", 20, 12, 0},
      {"fixup_riscv_pcrel_lo12_s", 0, 32, 0},
      {"fixup_riscv_pcrel_base_idx_lo12_i", 20, 12, 0},
      {"fixup_riscv_pcrel_base_idx_lo12_s", 0, 32, 0},
      {"fixup_riscv_pcrel_base_idx_add", 0, 0, 0},
