...
add.uw a0, a0, a1, %hi(foo) # CHECK: :[[@LINE]]:20: error: operand must be a symbol with %base_idx_add or %pcrel_base_idx_add specifier
sh1add.uw a0, a0, a1, %hi(foo) # CHECK: :[[@LINE]]:23: error: operand must be a symbol with %base_idx_add or %pcrel_base_idx_add specifier
sh2add.uw a0, a0, a1, %hi(foo) # CHECK: :[[@LINE]]:23: error: operand must be a symbol with %base_idx_add or %pcrel_base_idx_add specifier
sh3add.uw a0, a0, a1, %hi(foo) # CHECK: :[[@LINE]]:23: error: operand must be a symbol with %base_idx_add or %pcrel_base_idx_add specifier
