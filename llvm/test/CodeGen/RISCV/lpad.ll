...
; RV32-NEXT:    add a0, a0, a2, %base_idx_add(.L__const.indirctbr.addr)
; RV32-NEXT:    lw a0, %base_idx_lo(.L__const.indirctbr.addr)(a0)
; RV32-NEXT:    jr a0
; RV32-NEXT:    .p2align 2
...
; RV64-NEXT:    add a0, a0, a2, %base_idx_add(.L__const.indirctbr.addr)
; RV64-NEXT:    ld a0, %base_idx_lo(.L__const.indirctbr.addr)(a0)
; RV64-NEXT:    jr a0
; RV64-NEXT:    .p2align 2
...
; FIXED-ONE-RV32-NEXT:    add a0, a0, a2, %base_idx_add(.L__const.indirctbr.addr)
; FIXED-ONE-RV32-NEXT:    lw a0, %base_idx_lo(.L__const.indirctbr.addr)(a0)
...
; FIXED-ONE-RV64-NEXT:    add a0, a0, a2, %base_idx_add(.L__const.indirctbr.addr)
; FIXED-ONE-RV64-NEXT:    ld a0, %base_idx_lo(.L__const.indirctbr.addr)(a0)
