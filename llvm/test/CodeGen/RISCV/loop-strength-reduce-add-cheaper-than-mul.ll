...
; RV32-NEXT:    add a4, a1, a2, %base_idx_add(flags2)
; RV32-NEXT:    add a1, a1, a0
; RV32-NEXT:    sb zero, %base_idx_lo(flags2)(a4)
...
; RV64-NEXT:    add a4, a4, a2, %base_idx_add(flags2)
; RV64-NEXT:    addw a1, a1, a0
; RV64-NEXT:    sb zero, %base_idx_lo(flags2)(a4)
