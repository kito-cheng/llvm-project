...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g1)
; RV32I-NEXT:    lbu a0, %base_idx_lo(g1)(a0)
; RV32I-NEXT:    ret
;
; RV32ZBA-LABEL: char_load:
; RV32ZBA:       # %bb.0: # %entry
; RV32ZBA-NEXT:    lui a1, %hi(g1)
; RV32ZBA-NEXT:    add a0, a0, a1, %base_idx_add(g1)
; RV32ZBA-NEXT:    lbu a0, %base_idx_lo(g1)(a0)
; RV32ZBA-NEXT:    ret
;
; RV64I-LABEL: char_load:
; RV64I:       # %bb.0: # %entry
; RV64I-NEXT:    lui a1, %hi(g1)
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g1)
; RV64I-NEXT:    lbu a0, %base_idx_lo(g1)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g1+4)
; RV32I-NEXT:    lbu a0, %base_idx_lo(g1+4)(a0)
; RV32I-NEXT:    ret
;
; RV32ZBA-LABEL: char_load_offset:
; RV32ZBA:       # %bb.0: # %entry
; RV32ZBA-NEXT:    lui a1, %hi(g1+4)
; RV32ZBA-NEXT:    add a0, a0, a1, %base_idx_add(g1+4)
; RV32ZBA-NEXT:    lbu a0, %base_idx_lo(g1+4)(a0)
; RV32ZBA-NEXT:    ret
;
; RV64I-LABEL: char_load_offset:
; RV64I:       # %bb.0: # %entry
; RV64I-NEXT:    lui a1, %hi(g1+4)
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g1+4)
; RV64I-NEXT:    lbu a0, %base_idx_lo(g1+4)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g2)
; RV32I-NEXT:    lh a0, %base_idx_lo(g2)(a0)
; RV32I-NEXT:    ret
;
; RV32ZBA-LABEL: short_load:
; RV32ZBA:       # %bb.0: # %entry
; RV32ZBA-NEXT:    lui a1, %hi(g2)
; RV32ZBA-NEXT:    sh1add a0, a0, a1, %base_idx_add(g2)
; RV32ZBA-NEXT:    lh a0, %base_idx_lo(g2)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g2)
; RV64I-NEXT:    lh a0, %base_idx_lo(g2)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g2+8)
; RV32I-NEXT:    lh a0, %base_idx_lo(g2+8)(a0)
; RV32I-NEXT:    ret
;
; RV32ZBA-LABEL: short_load_offset:
; RV32ZBA:       # %bb.0: # %entry
; RV32ZBA-NEXT:    lui a1, %hi(g2+8)
; RV32ZBA-NEXT:    sh1add a0, a0, a1, %base_idx_add(g2+8)
; RV32ZBA-NEXT:    lh a0, %base_idx_lo(g2+8)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g2+8)
; RV64I-NEXT:    lh a0, %base_idx_lo(g2+8)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g3)
; RV32I-NEXT:    lw a0, %base_idx_lo(g3)(a0)
; RV32I-NEXT:    ret
;
; RV32ZBA-LABEL: int_load:
; RV32ZBA:       # %bb.0: # %entry
; RV32ZBA-NEXT:    lui a1, %hi(g3)
; RV32ZBA-NEXT:    sh2add a0, a0, a1, %base_idx_add(g3)
; RV32ZBA-NEXT:    lw a0, %base_idx_lo(g3)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g3)
; RV64I-NEXT:    lw a0, %base_idx_lo(g3)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g3+16)
; RV32I-NEXT:    lw a0, %base_idx_lo(g3+16)(a0)
; RV32I-NEXT:    ret
;
; RV32ZBA-LABEL: int_load_offset:
; RV32ZBA:       # %bb.0: # %entry
; RV32ZBA-NEXT:    lui a1, %hi(g3+16)
; RV32ZBA-NEXT:    sh2add a0, a0, a1, %base_idx_add(g3+16)
; RV32ZBA-NEXT:    lw a0, %base_idx_lo(g3+16)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g3+16)
; RV64I-NEXT:    lw a0, %base_idx_lo(g3+16)(a0)
; RV64I-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g4)
; RV64I-NEXT:    ld a0, %base_idx_lo(g4)(a0)
; RV64I-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g4+32)
; RV64I-NEXT:    ld a0, %base_idx_lo(g4+32)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    sb a1, %base_idx_lo(g1)(a0)
; RV32I-NEXT:    ret
;
...
; RV32ZBA-NEXT:    sb a1, %base_idx_lo(g1)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    sb a1, %base_idx_lo(g1)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g1+4)
; RV32I-NEXT:    li a1, 100
; RV32I-NEXT:    sb a1, %base_idx_lo(g1+4)(a0)
; RV32I-NEXT:    ret
;
...
; RV32ZBA-NEXT:    add a0, a0, a1, %base_idx_add(g1+4)
; RV32ZBA-NEXT:    li a1, 100
; RV32ZBA-NEXT:    sb a1, %base_idx_lo(g1+4)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g1+4)
; RV64I-NEXT:    li a1, 100
; RV64I-NEXT:    sb a1, %base_idx_lo(g1+4)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g2)
; RV32I-NEXT:    li a1, 100
; RV32I-NEXT:    sh a1, %base_idx_lo(g2)(a0)
; RV32I-NEXT:    ret
;
...
; RV32ZBA-NEXT:    sh1add a0, a0, a1, %base_idx_add(g2)
; RV32ZBA-NEXT:    li a1, 100
; RV32ZBA-NEXT:    sh a1, %base_idx_lo(g2)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g2)
; RV64I-NEXT:    li a1, 100
; RV64I-NEXT:    sh a1, %base_idx_lo(g2)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g2+8)
; RV32I-NEXT:    li a1, 100
; RV32I-NEXT:    sh a1, %base_idx_lo(g2+8)(a0)
; RV32I-NEXT:    ret
;
...
; RV32ZBA-NEXT:    sh1add a0, a0, a1, %base_idx_add(g2+8)
; RV32ZBA-NEXT:    li a1, 100
; RV32ZBA-NEXT:    sh a1, %base_idx_lo(g2+8)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g2+8)
; RV64I-NEXT:    li a1, 100
; RV64I-NEXT:    sh a1, %base_idx_lo(g2+8)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g3)
; RV32I-NEXT:    li a1, 100
; RV32I-NEXT:    sw a1, %base_idx_lo(g3)(a0)
; RV32I-NEXT:    ret
;
...
; RV32ZBA-NEXT:    sh2add a0, a0, a1, %base_idx_add(g3)
; RV32ZBA-NEXT:    li a1, 100
; RV32ZBA-NEXT:    sw a1, %base_idx_lo(g3)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g3)
; RV64I-NEXT:    li a1, 100
; RV64I-NEXT:    sw a1, %base_idx_lo(g3)(a0)
; RV64I-NEXT:    ret
;
...
; RV32I-NEXT:    add a0, a0, a1, %base_idx_add(g3+16)
; RV32I-NEXT:    li a1, 100
; RV32I-NEXT:    sw a1, %base_idx_lo(g3+16)(a0)
; RV32I-NEXT:    ret
;
...
; RV32ZBA-NEXT:    sh2add a0, a0, a1, %base_idx_add(g3+16)
; RV32ZBA-NEXT:    li a1, 100
; RV32ZBA-NEXT:    sw a1, %base_idx_lo(g3+16)(a0)
; RV32ZBA-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g3+16)
; RV64I-NEXT:    li a1, 100
; RV64I-NEXT:    sw a1, %base_idx_lo(g3+16)(a0)
; RV64I-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g4)
; RV64I-NEXT:    li a1, 100
; RV64I-NEXT:    sd a1, %base_idx_lo(g4)(a0)
; RV64I-NEXT:    ret
;
...
; RV64I-NEXT:    add a0, a0, a1, %base_idx_add(g4+32)
; RV64I-NEXT:    li a1, 100
; RV64I-NEXT:    sd a1, %base_idx_lo(g4+32)(a0)
; RV64I-NEXT:    ret
;
